...
class BaselineModel(torch.nn.Module):
    ...
    def forward(
        ...
        loss, pos_sim, neg_sim = self.loss(log_feats, pos_embs, neg_embs, loss_mask, next_action_type)
    ...
    def loss(self, log_feats, pos_embs, neg_embs, loss_mask, next_action_type):
        ...
        infonce_loss, pos_sim, neg_sim = info_nce_loss(log_feats,pos_embs,neg_embs)
        return infonce_loss, pos_sim, neg_sim
