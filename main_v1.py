...
# 自定义模块
from my_dataset_v1 import BaseDataset, TrainDataset, EmbeddingDataset, ValidDataset
...
from baseline_model_v1 import BaselineModel as DownstreamModel
from transformers import get_cosine_schedule_with_warmup
import torch
import torch.nn as nn
from pathlib import Path
...
def get_args():
    ...
    parser.add_argument('--train_name',type=str, default="08-19", help='训练名称')
    ...
    parser.add_argument('--downstream_task_lr', type=float, default=1e-3, help='下游任务学习率')
